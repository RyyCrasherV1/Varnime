...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* SPACER (INI KUNCI PERBAIKAN) */}
      <div className="h-16" />

      {/* MOBILE MENU */}
      <div
        className={`fixed inset-0 z-40 bg-gray-950/90 backdrop-blur-xl md:hidden transition-opacity duration-300 ${
        ...
        <div className="container mx-auto h-full flex flex-col items-center justify-center gap-y-8 px-4">
          {navLinks.map((link) => (
            <Link
              ...
              className="flex items-center gap-3 text-2xl font-semibold text-gray-300 hover:text-pink-400 transition-colors"
            >
